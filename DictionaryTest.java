...
public class DictionaryTest {
	...
	public static void main(String[] args){
		...
		dict1.insert(new SortableString("Jane"),"Jane");
		dict1.insert(new SortableString("Bob"),"Bob");
		dict1.insert(new SortableString("Tom"),"Tom");
		dict1.insert(new SortableString("Alan"),"Alan");
		dict1.insert(new SortableString("Ellen"),"Ellen");
		dict1.insert(new SortableString("Nancy"),"Nancy");
		System.out.println("Searching for 'Jane' :"+ dict1.search(new SortableString("Jane")));
		dict1.printTree();
		System.out.println(dict1.depth());
		dict1.delete(new SortableString("Jane"));
		dict1.printTree();
		System.out.println(dict1.depth());
		System.out.println("Searching for 'Jane'"+ dict1.search(new SortableString("Jane")));
		dict1.delete(new SortableString("Ellen"));
		dict1.printTree();
		System.out.println(dict1.depth());
		dict1.delete()
	}
